...
export function AdministrativeNavigationLink() {
  ...
  return (
    <Link to="/administracion" className="interactive-bubble interactive-bubble--liquid group min-h-11 min-w-0 w-full justify-center whitespace-normal break-words text-center text-xs sm:w-auto sm:shrink-0 sm:text-sm">
